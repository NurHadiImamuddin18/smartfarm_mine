          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Data Kelompok</h4>
                            <a href="tambah.php" class="btn btn-outline-primary"> Tambah Data</i></a><br>
                             ...
                             <?php
                                ...
                                ?>
                                 <tr>
                                     ...
                                     <td><?= $data['status']; ?> </td>
                                     <td>
                                      <a class="btn btn-outline-success btn-sm" href="edit.php?id_admin=<?= $data['id_admin']; ?>"><i class="mdi mdi-pencil"></i> Edit</a>
                                         <a class="btn btn-outline-danger btn-sm" href="hapus.php?id_admin=<?= $data['id_admin']; ?>" onclick="return confirm(  'Yakin Akan Menghapus Data Ini ?')"><i class="mdi mdi-bitbucket"></i> Hapus</a>
                                     </td>
                                    </tr>
                                    <?php } ?>
                         </tbody>
